...
class UserDashboardController extends BaseController
{
    ...
    /**
     * User dashboard – see my submitted tickets.
     */
    ...
    public function viewTicket(int $ticketId)
    {
        ...
        if (! $ticket) {
            return redirect()->to('my-tickets')->with('error', 'Ticket not found.');
        }
