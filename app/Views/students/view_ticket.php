...
<div class="p-8 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="space-y-4">
        <div>
          ...
          <p class="mono text-sm font-bold text-purple-700">ICTU-<?= date('Y', strtotime($ticket['created_at'])) ?>-<?= str_pad($ticket['job_ticket_id'], 5, '0', STR_PAD_LEFT) ?></p>
        </div>
        <div>
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <a href="<?= base_url('uploads/tickets/' . $ticket['attachments']) ?>" target="_blank" class="text-sm text-purple-600 hover:text-purple-800 underline"><?= esc($ticket['attachments']) ?></a>
        </div>
        <?php endif; ?>
      </div>
    </div>
  ...
  <div class="fade-in delay-2 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/50 shadow-lg">
  ...
  <?php else: ?>
  <div class="fade-in delay-2 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/50 shadow-lg text-center">
    <div class="text-purple-300 text-4xl mb-3">⏳</div>
  ...
  <div class="fade-in delay-3 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/50 shadow-lg">
