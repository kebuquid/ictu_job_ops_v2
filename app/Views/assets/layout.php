    ...
    <aside id="assetSidebar" class="fixed inset-y-0 left-0 z-40 w-72 max-w-[86vw] bg-white/90 backdrop-blur-xl shadow-2xl flex flex-col border-r border-blue-100/50 shrink-0 -translate-x-full transition-transform duration-300 ease-out lg:relative lg:z-auto lg:max-w-none lg:translate-x-0">
      ...
      <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="<?= base_url("$_p/dashboard") ?>"
           class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:text-blue-700 hover:bg-blue-50 font-medium text-sm transition-all">
        ...
        <a href="<?= base_url("$_p/assets") ?>"
           class="sidebar-item <?= str_starts_with(uri_string(), "$_p/assets") && !str_starts_with(uri_string(), "$_p/asset-groups") ? 'sidebar-active' : 'text-gray-600 hover:text-blue-700 hover:bg-blue-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
        ...
        <a href="<?= base_url("$_p/asset-groups") ?>"
           class="sidebar-item <?= str_starts_with(uri_string(), "$_p/asset-groups") ? 'sidebar-active' : 'text-gray-600 hover:text-blue-700 hover:bg-blue-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
        ...
        <a href="<?= base_url("$_p/maintenance") ?>"
           class="sidebar-item <?= str_starts_with(uri_string(), "$_p/maintenance") && !str_starts_with(uri_string(), "$_p/pm-plans") ? 'sidebar-active' : 'text-gray-600 hover:text-blue-700 hover:bg-blue-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
        ...
        <?php if ($_isSA): ?>
        <a href="<?= base_url('super-admin/pm-plans') ?>"
           class="sidebar-item <?= str_starts_with(uri_string(), 'super-admin/pm-plans') ? 'sidebar-active' : 'text-gray-600 hover:text-blue-700 hover:bg-blue-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
          <svg class="sidebar-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
          PM Plans
        </a>
        <?php endif; ?>
        ...
        <a href="<?= base_url("$_p/disposals") ?>"
           class="sidebar-item <?= str_starts_with(uri_string(), "$_p/disposals") ? 'sidebar-active' : 'text-gray-600 hover:text-blue-700 hover:bg-blue-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
        ...
        ?>
        <p class="text-xs font-700 text-gray-400 uppercase tracking-widest px-3 pb-1 pt-4">Configuration</p>
        <div>
