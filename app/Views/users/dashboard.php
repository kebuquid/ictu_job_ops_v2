  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="fade-in delay-3 lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-100/50 shadow-lg">
      <div class="flex items-center justify-between mb-5">
        ...
        <a href="<?= base_url('my-tickets') ?>" class="text-xs text-blue-600 hover:underline font-semibold">View All →</a>
      </div>
    ...
    <div class="space-y-6">
      <div class="fade-in delay-4 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-100/50 shadow-lg">
        ...
        <div class="space-y-2">
          ...
          <a href="<?= base_url('my-tickets') ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 text-gray-700 font-semibold text-sm hover:bg-gray-100 transition-all">
