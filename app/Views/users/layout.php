...
<head>
  ...
  <title>ICTU Job Ticketing</title>
  ...
  <div class="flex h-screen overflow-hidden relative z-10">
    ...
    <aside class="w-72 bg-white/80 backdrop-blur-xl shadow-2xl flex flex-col border-r border-gray-100/50 shrink-0">
      ...
      <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="<?= base_url('dashboard') ?>" class="sidebar-item <?= uri_string() === 'dashboard' ? 'sidebar-active' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-semibold text-sm">
        ...
        <a href="<?= base_url('create-ticket') ?>" class="sidebar-item <?= uri_string() === 'create-ticket' ? 'sidebar-active' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
        ...
        <a href="<?= base_url('my-tickets') ?>" class="sidebar-item <?= str_starts_with(uri_string(), 'my-tickets') ? 'sidebar-active' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
