...
<div class="p-8 space-y-6">
  ...
  <div class="fade-in delay-1 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 shadow-lg">
    ...
    <?php if (!empty($slaSummary)): ?>
      ...
      ?>
      <div class="mb-5 rounded-xl border border-gray-200 bg-white/80 p-3">
        <div class="flex items-center justify-between gap-2 flex-wrap">
          <p class="text-xs text-gray-600">Expected completion: <span class="font-semibold"><?= (int) ($slaSummary['target_hours'] ?? 0) ?> hour(s) after In Progress</span></p>
