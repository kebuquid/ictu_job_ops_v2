...
<nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
    ...
    <a href="<?= site_url('super-admin/pm-plans/show/' . $plan['plan_id']) ?>" class="hover:text-blue-600 transition">Plan <?= esc($plan['plan_year']) ?></a>
    <i class="fa-solid fa-chevron-right text-xs text-gray-300"></i>
...
<form method="post" action="<?= site_url('super-admin/pm-plans/update/' . $plan['plan_id']) ?>" id="pm-form">
<?= csrf_field() ?>
...
<div class="flex items-center justify-end gap-3">
    <a href="<?= site_url('super-admin/pm-plans/show/' . $plan['plan_id']) ?>"
