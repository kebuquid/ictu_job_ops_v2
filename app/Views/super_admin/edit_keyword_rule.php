...
<div class="p-8 space-y-6 max-w-2xl mx-auto">
  ...
  <div class="fade-in delay-1 bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-100/50 shadow-lg p-6">
    ...
    <form action="<?= base_url('super-admin/keyword-rules/edit/' . $rule['id']) ?>" method="POST" class="space-y-5">
      <?= csrf_field() ?>
        ...
        <div class="relative">
          ...
          <select name="section_id" id="sectionId" required
            ...
            <?php foreach ($sections as $section): ?>
              <option value="<?= esc($section['section_id']) ?>" <?= $rule['section_id'] == $section['section_id'] ? 'selected' : '' ?>>
