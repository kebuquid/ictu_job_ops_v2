...
<body class="bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen overflow-hidden">
  ...
  <div class="flex h-screen overflow-hidden relative z-10">
    ...
    <div id="superAdminSidebarOverlay" class="fixed inset-0 bg-slate-900/45 backdrop-blur-[1px] z-30 hidden lg:hidden" aria-hidden="true"></div>

    <!-- Sidebar -->
    <aside id="superAdminSidebar" class="fixed inset-y-0 left-0 z-40 w-72 max-w-[86vw] bg-white/90 backdrop-blur-xl shadow-2xl flex flex-col border-r border-blue-100/50 shrink-0 -translate-x-full transition-transform duration-300 ease-out lg:relative lg:z-auto lg:max-w-none lg:translate-x-0">
      <!-- Logo -->
      <div class="p-6 border-b border-blue-100/60">
        <div class="flex items-center justify-between gap-3">
          ...
          <button id="superAdminSidebarClose" type="button" class="inline-flex lg:hidden items-center justify-center w-9 h-9 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition" aria-label="Close navigation menu">
      ...
      <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="<?= base_url('super-admin/dashboard') ?>" class="sidebar-item sidebar-active flex items-center gap-3 px-4 py-3 rounded-xl font-semibold text-sm">
        ...
        <a href="<?= base_url('super-admin/tickets') ?>" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:text-blue-700 hover:bg-blue-50 font-medium text-sm transition-all">
        ...
        <a href="<?= base_url('super-admin/employees') ?>" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:text-blue-700 hover:bg-blue-50 font-medium text-sm transition-all">
        ...
        <a href="<?= base_url('super-admin/section-access') ?>" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:text-blue-700 hover:bg-blue-50 font-medium text-sm transition-all">
          <svg class="sidebar-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
          Section Access
        </a>

        <a href="<?= base_url('super-admin/form-option-access') ?>" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:text-blue-700 hover:bg-blue-50 font-medium text-sm transition-all">
    ...
    <main class="flex-1 overflow-y-auto min-w-0">
      ...
      <header class="bg-white/70 backdrop-blur-xl border-b border-blue-100/50 px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-3 sticky top-0 z-20">
        <button id="superAdminSidebarToggle" type="button" class="inline-flex lg:hidden items-center justify-center w-10 h-10 rounded-xl border border-blue-200 bg-white text-blue-700 hover:bg-blue-50 transition" aria-controls="superAdminSidebar" aria-expanded="false" aria-label="Open navigation menu">
  ...
  (() => {
    ...
    const openBtn = document.getElementById('superAdminSidebarToggle');
    const closeBtn = document.getElementById('superAdminSidebarClose');
