...
<div class="p-8 space-y-6 max-w-2xl mx-auto">
  ...
  <div class="fade-in">
    ...
    <h2 class="text-2xl font-extrabold text-gray-900">Add Equipment</h2>
    <p class="text-sm text-gray-500 mt-1">Register a new equipment in the system.</p>
  </div>
  ...
  <div class="fade-in delay-1 bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-100/50 shadow-lg p-6">
    ...
    <form action="<?= base_url('super-admin/ticket-equipment/add') ?>" method="POST" class="space-y-5">
      <?= csrf_field() ?>
