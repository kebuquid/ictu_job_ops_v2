...
<div class="p-8 space-y-6 max-w-2xl mx-auto">
  ...
  <!-- Page Header -->
  <div class="fade-in">
    <a href="<?= base_url('super-admin/keyword-rules') ?>" class="inline-flex items-center gap-1.5 text-sm text-blue-600 hover:text-blue-800 font-medium mb-4 transition-colors">
      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
      Back to Keyword Rules
    </a>
    <h2 class="text-2xl font-extrabold text-gray-900">Add Keyword Rule</h2>
    <p class="text-sm text-gray-500 mt-1">Add a new keyword for automatic ticket section detection.</p>
  </div>
  ...
  <div class="fade-in delay-1 bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-100/50 shadow-lg p-6">
    ...
    <form action="<?= base_url('super-admin/keyword-rules/add') ?>" method="POST" class="space-y-5">
      <?= csrf_field() ?>
      ...
      <div>
        ...
        <div class="relative">
          ...
          <select name="section_id" id="sectionId" required
      ...
      <label class="flex items-center gap-3 cursor-pointer select-none group">
        ...
        <div>
          ...
          <p class="text-xs text-gray-400">Check this if this is the catch-all tip shown when no specific keyword tip matches for this section.</p>
        </div>
      </label>
      ...
      <div id="keywordField">
        ...
        <p class="text-xs text-gray-400 mt-1">Single word or short phrase that will be matched in the user's problem description. Case-insensitive.</p>
      </div>
