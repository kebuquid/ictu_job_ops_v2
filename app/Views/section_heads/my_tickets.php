              ...
              <td class="py-3">
                <div class="flex items-center gap-2">
                  ...
                  <?php if(in_array((int)$ticket['job_status'], [0, 1, 2])): ?>
                    <a href="<?= base_url('admin/respond/' . $ticket['job_ticket_response_id']) ?>" class="text-xs font-bold text-indigo-600 hover:text-indigo-800 bg-indigo-50 px-3 py-1.5 rounded-lg hover:bg-indigo-100 transition-all">Respond</a>
