...
<div class="p-8 space-y-6">
  ...
  <div class="fade-in bg-blue-50 border border-blue-200 rounded-2xl p-4 flex items-start gap-3">
    ...
    <div>
      <p class="text-sm font-semibold text-blue-800">Your Section's Keywords</p>
      <p class="text-xs text-blue-600 mt-0.5">Manage the keywords that route tickets to your section. When users describe their problem, these keywords are matched to suggest your section automatically.</p>
    </div>
  </div>
            ...
            <tr class="ticket-row border-b border-gray-50">
              ...
              <td class="py-3">
                <div class="flex items-center gap-2">
                  ...
                  <button type="button"
                          onclick="confirmDelete(<?= $item['id'] ?>, '<?= esc($item['is_default'] ? 'Default tip' : $item['keyword'], 'js') ?>')"
...
function confirmDelete(id, name) {
  ...
  $('#deleteForm').attr('action', '<?= base_url("admin/keyword-rules/delete") ?>/' + id);
