...
<head>
  ...
  <title>ICTU Job Ticketing - Technician</title>
  ...
  <div class="flex h-screen overflow-hidden relative z-10">
    ...
    <aside class="w-72 bg-white/80 backdrop-blur-xl shadow-2xl flex flex-col border-r border-emerald-100/50 shrink-0">
      ...
      <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="<?= base_url('technician/dashboard') ?>" class="sidebar-item <?= uri_string() === 'technician/dashboard' ? 'sidebar-active' : 'text-gray-600 hover:text-emerald-700 hover:bg-emerald-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-semibold text-sm">
        ...
        <a href="<?= base_url('technician/my-tickets') ?>" class="sidebar-item <?= str_starts_with(uri_string(), 'technician/my-tickets') ? 'sidebar-active' : 'text-gray-600 hover:text-emerald-700 hover:bg-emerald-50' ?> flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm transition-all">
