  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="fade-in delay-3 lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-emerald-100/50 shadow-lg">
      <div class="flex items-center justify-between mb-5">
        ...
        <a href="<?= base_url('technician/my-tickets') ?>" class="text-xs text-emerald-600 hover:underline font-semibold">View All →</a>
      </div>
          ...
          <tbody>
            ...
            <?php else: ?>
              ...
              <tr class="ticket-row border-b border-gray-50">
                ...
                <td class="py-3">
                  <a href="<?= base_url('technician/respond/' . $ticket['job_ticket_response_id']) ?>" class="text-xs font-bold text-emerald-600 hover:text-emerald-800 bg-emerald-50 px-3 py-1.5 rounded-lg hover:bg-emerald-100 transition-all">Respond</a>
                </td>
              </tr>
              <?php endforeach; ?>
            <?php endif; ?>
    ...
    <div class="space-y-6">
      <div class="fade-in delay-4 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-emerald-100/50 shadow-lg">
        ...
        <div class="space-y-2">
          <a href="<?= base_url('technician/my-tickets') ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-green-700 text-white font-semibold text-sm shadow-lg hover:shadow-xl transition-all">
