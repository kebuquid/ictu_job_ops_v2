...
<div class="p-8 space-y-6">
  ...
  <div class="fade-in delay-1 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-emerald-100/50 shadow-lg">
    <div class="flex items-center justify-between mb-5">
      ...
      <a href="<?= base_url('create-ticket') ?>" class="px-4 py-2 bg-gradient-to-r from-emerald-600 to-green-700 text-white font-semibold text-sm rounded-xl shadow hover:shadow-lg transition-all">+ New Ticket</a>
    </div>
            ...
            <tr class="ticket-row border-b border-gray-50">
              ...
              <td class="py-3">
                <div class="flex items-center gap-2">
                  <a href="<?= base_url($urlPrefix . '/ticket/' . $ticket['job_ticket_id']) ?>" class="text-xs font-bold text-emerald-600 hover:text-emerald-800 bg-emerald-50 px-3 py-1.5 rounded-lg hover:bg-emerald-100 transition-all inline-flex items-center gap-1">
