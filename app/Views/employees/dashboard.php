...
<div class="p-8 space-y-6">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
    ...
    <div class="fade-in delay-2 stat-card bg-white/80 backdrop-blur-sm rounded-2xl p-5 border border-gray-100/50 shadow-lg">
      <div class="flex items-center justify-between mb-3">
    ...
    <div class="fade-in delay-3 stat-card bg-white/80 backdrop-blur-sm rounded-2xl p-5 border border-gray-100/50 shadow-lg">
      <div class="flex items-center justify-between mb-3">
    ...
    <div class="fade-in delay-4 stat-card bg-white/80 backdrop-blur-sm rounded-2xl p-5 border border-gray-100/50 shadow-lg">
      <div class="flex items-center justify-between mb-3">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <!-- My Recent Tickets -->
    <div class="fade-in delay-3 lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-100/50 shadow-lg">
      <div class="flex items-center justify-between mb-5">
        <h3 class="font-bold text-gray-900">My Recent Tickets</h3>
        <a href="<?= base_url('employee/my-tickets') ?>" class="text-xs text-blue-600 hover:underline font-semibold">View All →</a>
      </div>
    ...
    <!-- Quick Actions -->
    <div class="space-y-6">
      <div class="fade-in delay-4 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-100/50 shadow-lg">
        <h3 class="font-bold text-gray-900 mb-4">Quick Actions</h3>
        <div class="space-y-2">
          <a href="<?= base_url('employee/create-ticket') ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold text-sm shadow-lg hover:shadow-xl transition-all">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
            Submit New Ticket
          </a>
          <a href="<?= base_url('employee/my-tickets') ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 text-gray-700 font-semibold text-sm hover:bg-gray-100 transition-all">
      ...
      <div class="fade-in delay-5 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-100/50 shadow-lg">
